...
const UseGetStaffByStoreCode = (store_code) => {
    ...
    const {
      ...
      queryFn: async () => {
        ...
        try {
          const response = await AxiosPrivate.get(`/restaurant-owner/store-staffs?${store_code}`);
          ...
          throw new Error("Failed to fetch staff list by storecode. Please try again.");
        }
      },
